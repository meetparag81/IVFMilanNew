...
public class WComplaintsPage extends TestBase
{
	...
	@FindBy(xpath="//span[@class='toast-msg ng-binding ng-scope']")WebElement Updateflash;
	@FindBy(xpath="//span[@class='toast-msg ng-binding ng-scope']")WebElement SaveFash;
			...
			if(NoofRows>0)
			{
				...
				for(int k=1;k<=4;k++)
				{
					...
					case(1):
						...
						WebElement Modailty = driver.findElement(By.xpath("//table[@class='table table-hover table-striped']//tbody/tr["+k+"]//td[6]/select"));
						...
						case(2):
							...
							WebElement Modailty2 = driver.findElement(By.xpath("//table[@class='table table-hover table-striped']//tbody/tr["+k+"]//td[6]/select"));
						...
						WebElement Modailty3 = driver.findElement(By.xpath("//table[@class='table table-hover table-striped']//tbody/tr["+k+"]//td[6]/select"));
						...
						WebElement Modailty4 = driver.findElement(By.xpath("//table[@class='table table-hover table-striped']//tbody/tr["+k+"]//td[6]/select"));
